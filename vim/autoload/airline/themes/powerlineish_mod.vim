...
let s:N3 = [ '#ffffff' , '#121212' , 231 , 234 ] " white          & gray4
...
let g:airline#themes#powerlineish_mod#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#powerlineish_mod#palette.insert_replace = {
      \ 'airline_a': [ s:RE[0]   , s:I1[1]   , s:RE[1]   , s:I1[3]   , ''     ] }

let g:airline#themes#powerlineish_mod#palette.visual = {
      \ 'airline_a': [ s:V1[0]   , s:V1[1]   , s:V1[2]   , s:V1[3]   , ''     ] }

let g:airline#themes#powerlineish_mod#palette.replace = copy(airline#themes#powerlineish_mod#palette.normal)
let g:airline#themes#powerlineish_mod#palette.replace.airline_a = [ s:RE[0] , s:RE[1] , s:RE[2] , s:RE[3] , '' ]
